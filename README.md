...
<a href="docs/recipes.md#day"><img src="assets/day-forecast-card.svg" alt="Прогноз дня. Проследить день в движении: общий фон, смену ритма и часы, когда сходятся несколько указаний. Как устроен разбор → Пока не входит в публичный пакет." width="360"></a>
</p>
