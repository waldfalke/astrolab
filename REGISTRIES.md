...
| **Часы восходящего знака** (отд. продукт) | `docs/rising-sign-clock-spec.md` | механика intraday astro time-management: time-grid → house-scoring (сырьё) → окна → action-taxonomy; NKS #91 |
